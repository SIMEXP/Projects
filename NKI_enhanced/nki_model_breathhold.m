function [] = nki_model_breathhold(path_folder,opt)
% generate individual model for motor task HCP database.
%
% SYNTAX:
% [] = HCP_IND_MODEL_BREATHHOLD(OPT)
%
...
data.covariates_intrarun_values(1,1) = (0 - opt.baseline_delay) + 10;
data.covariates_intrarun_values(1,2) = opt.baseline_duration;
data.covariates_intrarun_values(2,1) = (10 - opt.trial_delay);
data.covariates_intrarun_values(2,2) = opt.trial_duration;
data.covariates_intrarun_values(3,1) = (36 - opt.baseline_delay) + 10;
data.covariates_intrarun_values(3,2) = opt.baseline_duration;
data.covariates_intrarun_values(4,1) = (46 - opt.trial_delay);
data.covariates_intrarun_values(4,2) = opt.trial_duration;
data.covariates_intrarun_values(5,1) = (72 - opt.baseline_delay) + 10;
data.covariates_intrarun_values(5,2) = opt.baseline_duration;
data.covariates_intrarun_values(6,1) = (82 - opt.trial_delay);
data.covariates_intrarun_values(6,2) = opt.trial_duration;
data.covariates_intrarun_values(7,1) = (108 - opt.baseline_delay) + 10;
data.covariates_intrarun_values(7,2) = opt.baseline_duration;
data.covariates_intrarun_values(8,1) = (118 - opt.trial_delay);
data.covariates_intrarun_values(8,2) = opt.trial_duration;
data.covariates_intrarun_values(9,1) = (144 - opt.baseline_delay) + 10;
data.covariates_intrarun_values(9,2) = opt.baseline_duration;
data.covariates_intrarun_values(10,1) = (154 - opt.trial_delay);
data.covariates_intrarun_values(10,2) = opt.trial_duration;
data.covariates_intrarun_values(11,1) = (180 - opt.baseline_delay) + 10;
data.covariates_intrarun_values(11,2) = opt.baseline_duration;
data.covariates_intrarun_values(12,1) = (190 - opt.trial_delay);
data.covariates_intrarun_values(12,2) = opt.trial_duration;
data.covariates_intrarun_values(13,1) = (216 - opt.baseline_delay) + 10;
data.covariates_intrarun_values(13,2) = opt.baseline_duration;
data.covariates_intrarun_values(14,1) = (226 - opt.trial_delay);
data.covariates_intrarun_values(14,2) = opt.trial_duration;
