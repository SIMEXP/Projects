...
%  NKI Checkerboard 1400 subgoups fir
%  Experiments Summary:
%  

%  EXP1a: Scrubbing off - Normalisation 'fir_perc' - scale sci180_scg162_scf164
%  EXP1b: Scrubbing off - Normalisation 'shape' - scale sci140_scg126_scf135



%  EXP1a:
%  In this EXP I'm using Checkerboard individual fir from scale sci180_scg162_scf164, the fir normalisation is perc. Data are not scrubbed.

clear
path_root =  '/media/database10/nki_enhanced/';
list_scale = { 'sci180_scg162_scf164'};
task = 'checkerboard' ;
tr = {'1400'};
fir = 'fir_perc';
scrub = '_noscrub';
...
system(['mricron ~/database/white_template.nii.gz -c -0 -o ' path_scales '_nii/brain_partition_consensus_group_' list_scale{1} '.nii.gz -c NIH -l 1 -h 165 -z &']);
