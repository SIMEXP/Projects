...
files_in.model.group = '/home/yassinebha/script/models/dominic_dep_group0a1_minus_group10a14.csv';
...
%% Options %%
%%%%%%%%%%%%%
opt.folder_out = [root_path 'glm_ref_' network_ref '/glm_connectome_' type_pre 'goup0_1_vs_10_14/']; % Where to store the results
