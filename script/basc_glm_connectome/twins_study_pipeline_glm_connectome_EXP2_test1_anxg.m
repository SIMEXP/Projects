...
%      opt.test.neutral_VS_sad.intra_run.select_diff(1).min    = 0.9;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'AA')).group.select.label                       = 'group0_vs_group1_hdi_anxg';
    opt.test.(strcat(type_desorder,type_test{tt},'AA')).group.select.values                      = [0 1];
    opt.test.(strcat(type_desorder,type_test{tt},'AA')).group.contrast.hdi_anxg                  = 1;

    %%dominic_anxg_AB : control_anxs (AND-low internalizing score) vs pathologic_anxs
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.select(1).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.select(6).label                    = 'group0_vs_group1_hdi_anxg';
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.select(6).values                   = [1];
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.contrast.group0_vs_group1_hdi_anxg = 1;

    %%dominic_anxg_AC : control_anxs (AND-low internalizing score AND-low externalizing score) vs pathologic_anxs
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.select(1).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.select(9).label                    = 'group0_vs_group1_hdi_anxg';
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.select(9).values                   = [1];
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.contrast.group0_vs_group1_hdi_anxg = 1;

    %%dominic_anxg_BA : control_anxs vs pathologic_anxs (AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'BA')).group.select(1).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BA')).group.select(5).label                    = 'group0_vs_group1_hdi_anxg';
    opt.test.(strcat(type_desorder,type_test{tt},'BA')).group.select(5).values                   = [0];
    opt.test.(strcat(type_desorder,type_test{tt},'BA')).group.contrast.group0_vs_group1_hdi_anxg = 1;

    %%dominic_anxg_BB : control_anxs (AND-low internalizing score) vs pathologic_anxs (AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'BB')).group.select(1).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BB')).group.select(5).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BB')).group.contrast.group0_vs_group1_hdi_anxg = 1;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BC')).group.select(1).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BC')).group.select(5).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BC')).group.contrast.group0_vs_group1_hdi_anxg = 1;

    %%dominic_anxg_CA : control_anxs vs pathologic_anxs (AND-low internalizing score AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.select(1).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.select(9).label                    = 'group0_vs_group1_hdi_anxg';
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.select(9).values                   = [0];
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.contrast.group0_vs_group1_hdi_anxg = 1;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.select(1).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.select(9).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.contrast.group0_vs_group1_hdi_anxg = 1;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CC')).group.select(1).label                    = 'group0_vs_group1_hdi_anxg';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CC')).group.contrast.group0_vs_group1_hdi_anxg = 1;
    ...
    switch server
          case 'guillimin'
          opt.psom.qsub_options = '-q sw -l nodes=1:ppn=2,walltime=10:00:00';
          case 'mammouth'
          %opt.psom.qsub_options = '-q qwork@ms -l nodes=1:m32G,walltime=05:00:00';
          opt.psom.qsub_options = '-q qwork@ms -l nodes=1:ppn=2,walltime=12:00:00';
    end      
    opt.flag_test  = false;
