...
%%% NOTE: adni2 ingenia scanners only
...
%% Options 
%%%%%%%%%%%%
opt.folder_out = [path_data 'adnet/results/glm30b_ingenia_20151116']; % Where to store the results
...
opt.test.ctrlvsmci.group.select(2).values = 7;
...
opt.test.avg_ctrl.group.select(2).values = 7;
...
opt.test.avg_mci.group.select(2).values = 7;
