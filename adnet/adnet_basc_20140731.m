...
addpath(genpath('/home/atam/quarantaine/niak-boss-0.12.14/'));
...
files_in.infos = [path_data 'adnet/models/adnet_model_group.csv']; % A file of comma-separeted values describing additional information on the subjects, this can be omitted

%%%%%%%%%%%%%
%% Options %%
%%%%%%%%%%%%%

opt.folder_out = [path_data 'adnet/basc_40sc_20140731/']; % Where to store the results
