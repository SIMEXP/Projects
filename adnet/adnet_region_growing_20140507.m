...
addpath(genpath('/home/atam/quarantaine/niak-boss-0.12.4/'));

path_data = '/mnt/parallel_scratch_ms2_wipe_on_august_2014/FROM_SCRATCH/bellec/bellec_group/';
...
%% Options %%
%%%%%%%%%%%%%
opt.folder_out = [path_data 'adnet/region_growing_20140507/']; % Where to store the results
