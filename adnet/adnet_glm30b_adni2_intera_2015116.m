...
%%% NOTE: adni2 intera scanners only
...
%% Options 
%%%%%%%%%%%%
opt.folder_out = [path_data 'adnet/results/glm30b_intera_20151116']; % Where to store the results
...
opt.test.ctrlvsmci.group.select(2).values = 9;
...
opt.test.avg_ctrl.group.select(2).values = 9;
...
opt.test.avg_mci.group.select(2).values = 9;
