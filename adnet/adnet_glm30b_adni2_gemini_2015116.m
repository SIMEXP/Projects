...
%%% NOTE: adni2 gemini scanners only
...
%% Options 
%%%%%%%%%%%%
opt.folder_out = [path_data 'adnet/results/glm30b_gemini_20151116']; % Where to store the results
...
opt.test.ctrlvsmci.group.select(2).values = 6;
...
opt.test.avg_ctrl.group.select(2).values = 6;
...
opt.test.avg_mci.group.select(2).values = 6;
