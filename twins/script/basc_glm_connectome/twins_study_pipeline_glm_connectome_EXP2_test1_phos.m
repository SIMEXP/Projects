...
%      opt.test.neutral_VS_sad.intra_run.select_diff(1).min    = 0.9;
    ...
    %%dominic_phos_AA : control_anxs vs pathologic_anxs
    opt.test.(strcat(type_desorder,type_test{tt},'AA')).group.select.label                       = 'group0_vs_group1_hdi_phos';
    opt.test.(strcat(type_desorder,type_test{tt},'AA')).group.select.values                      = [0 1];
    opt.test.(strcat(type_desorder,type_test{tt},'AA')).group.contrast.hdi_phos                  = 1;

    %%dominic_phos_AB : control_anxs (AND-low internalizing score) vs pathologic_anxs
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.select(1).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.select(4).label                    = 'hdi_dep';
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.select(4).max                      = model.hdi_dep.max_control;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.select(6).label                    = 'group0_vs_group1_hdi_phos';
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.select(6).values                   = [1];
    opt.test.(strcat(type_desorder,type_test{tt},'AB')).group.contrast.group0_vs_group1_hdi_phos = 1;

    %%dominic_phos_AC : control_anxs (AND-low internalizing score AND-low externalizing score) vs pathologic_anxs
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.select(1).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.select(4).label                    = 'hdi_dep';
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.select(4).max                      = model.hdi_dep.max_control;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.select(9).label                    = 'group0_vs_group1_hdi_phos';
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.select(9).values                   = [1];
    opt.test.(strcat(type_desorder,type_test{tt},'AC')).group.contrast.group0_vs_group1_hdi_phos = 1;

    %%dominic_phos_BA : control_anxs vs pathologic_anxs (AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'BA')).group.select(1).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BA')).group.select(5).label                    = 'group0_vs_group1_hdi_phos';
    opt.test.(strcat(type_desorder,type_test{tt},'BA')).group.select(5).values                   = [0];
    opt.test.(strcat(type_desorder,type_test{tt},'BA')).group.contrast.group0_vs_group1_hdi_phos = 1;

    %%dominic_phos_BB : control_anxs (AND-low internalizing score) vs pathologic_anxs (AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'BB')).group.select(1).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BB')).group.select(5).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BB')).group.select(8).label                    = 'hdi_dep';
    opt.test.(strcat(type_desorder,type_test{tt},'BB')).group.select(8).max                      = model.hdi_dep.max_control;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BB')).group.contrast.group0_vs_group1_hdi_phos = 1;

    %%dominic_phos_BC : control_anxs (AND-low internalizing score AND-low externalizing score) vs pathologic_anxs (AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'BC')).group.select(1).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BC')).group.select(5).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BC')).group.select(8).label                    = 'hdi_dep';
    opt.test.(strcat(type_desorder,type_test{tt},'BC')).group.select(8).max                      = model.hdi_dep.max_control;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'BC')).group.contrast.group0_vs_group1_hdi_phos = 1;

    %%dominic_phos_CA : control_anxs vs pathologic_anxs (AND-low internalizing score AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.select(1).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.select(7).label                    = 'hdi_dep';
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.select(7).max                      = model.hdi_dep.max_control;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.select(9).label                    = 'group0_vs_group1_hdi_phos';
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.select(9).values                   = [0];
    opt.test.(strcat(type_desorder,type_test{tt},'CA')).group.contrast.group0_vs_group1_hdi_phos = 1;

    %%dominic_phos_CB : control_anxs (AND-low internalizing score) vs pathologic_anxs (AND-low internalizing score AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.select(1).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.select(7).label                    = 'hdi_dep';
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.select(7).max                      = model.hdi_dep.max_control;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.select(9).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.select(12).label                   = 'hdi_dep';
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.select(12).max                     = model.hdi_dep.max_control;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CB')).group.contrast.group0_vs_group1_hdi_phos = 1;

    %%dominic_phos_CC : control_anxs (AND-low internalizing score AND-low externalizing score) vs pathologic_anxs (AND-low internalizing score AND-low externalizing score)
    opt.test.(strcat(type_desorder,type_test{tt},'CC')).group.select(1).label                    = 'group0_vs_group1_hdi_phos';
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CC')).group.select(7).label                    = 'hdi_dep';
    opt.test.(strcat(type_desorder,type_test{tt},'CC')).group.select(7).max                      = model.hdi_dep.max_control;
    ...
    opt.test.(strcat(type_desorder,type_test{tt},'CC')).group.contrast.group0_vs_group1_hdi_phos = 1;
