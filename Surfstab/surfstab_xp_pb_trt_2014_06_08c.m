...
for ss = 1:length(list_subject)
    ...
    for rr = 1:3
        ...
        opt.folder_out = [path_data 'xp_pb_trt_2014_06_08c' filesep subject '_sess' num2str(rr) filesep];
        pipe = psom_add_job(pipe,[subject '_sess' num2str(rr)],'niak_brick_scores_fmri_v2',in,struct(),opt);
    end
end

opt_p.path_logs = [path_data 'xp_pb_trt_2014_06_08c' filesep 'logs'];
% mricron /home/pbellec/database/template.nii.gz -c -0 -o stability_maps.nii.gz -c 5redyell -l 0.05 -h 1&
% niak_brick_mnc2nii('/home/pbellec/database/stability_surf/xp_pb_trt_2014_06_08c')
