...
%                     {[in_dir filesep sprintf('sld_clust_%d_win_60', num_clust) filesep 'stability_contrast'], 'sld60'},...
    ...
    % Prepare files
    sim_mats = {{intra_sim_mat, sprintf('intra spat corr @ %d', num_clust)},...
                {inter_sim_mat, sprintf('inter spat corr @ %d', num_clust)},...
                {sim, sprintf('w/b spat corr @ %d', num_clust)},...
                {intra_dis_mat, sprintf('intra eucl dist @ %d', num_clust)},...
                {inter_dis_mat, sprintf('inter eucl dist @ %d', num_clust)},...
