...
opt_g.filter.run = {'run3'}; % run1, run2, run3
...
%% Options
opt.folder_out = '/gs/project/gsf-624-aa/database2/ccna/ccna_multisite_TR_20160201/results/p2pconnectome_MNI_session3_run3/'; % Where to store the results
