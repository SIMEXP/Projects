...
opt_g.filter.session = {'session1'}; % session1, session2, session3
...
%% Options
opt.folder_out = '/gs/project/gsf-624-aa/database2/ccna/ccna_multisite_TR_20160201/results/p2pconnectome_MNI_session1/'; % Where to store the results
