...
opt_g.exclude_subject = {'CHUS','UNF','CINQ'}; % CHUS, CINQ, MNI, UNF
opt_g.filter.session = {'session3'}; % session1, session2, session3
opt_g.filter.run = {'run1'}; % run1, run2, run3
...
%% Options
opt.folder_out = '/gs/project/gsf-624-aa/database2/ccna/ccna_multisite_TR_20160201/results/p2pconnectome_MNI_session3_run1/'; % Where to store the results
