...
opt_g.exclude_subject = {'CHUS','MNI','UNF'}; % CHUS, CINQ, MNI, UNF
...
%% Options
opt.folder_out = '/gs/project/gsf-624-aa/database2/ccna/ccna_multisite_TR_20160201/results/p2pconnectome_CINQ_session1/'; % Where to store the results
