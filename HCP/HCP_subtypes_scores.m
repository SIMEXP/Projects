...
num_var = [1 6 7 8 9]; % num variable in model.csv
...
num_fd1 = 5; % num FD variable in model.csv, used as confounding variable
num_age = 3;
num_sex = 4;
nb_clus = 3; % nb clusters in clustering
name_clus = {'subt1','subt2','subt3'};
model = '/Users/pyeror/Work/transfert/Schizo/models/cobre_112_subtype_model_group_20151011.csv';
...
path_results = '/Users/pyeror/Work/transfert/Schizo/results/subtype/scores_s7/subtypes_cobre_112_3subtypes_BH05_confounds/';
...
for n_net = 1:length(num_net)
    ...
    opt.labels_y = {'subt1','subt2','subt3'};
    opt.labels_x = sub_id;
