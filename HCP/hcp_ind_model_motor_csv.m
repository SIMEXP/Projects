...
data.covariates_intrarun_values(1,1) = str2num(niak_read_csv_cell([path_folder 'lh.txt'],opt_csv_read){1,1}) - opt.trial_delay;
data.covariates_intrarun_values(1,2) = opt.trial_duration;
data.covariates_intrarun_values(2,1) = str2num(niak_read_csv_cell([path_folder 'lh.txt'],opt_csv_read){2,1}) - opt.trial_delay;
data.covariates_intrarun_values(2,2) = opt.trial_duration;
data.covariates_intrarun_values(3,1) = str2num(niak_read_csv_cell([path_folder 'lh.txt'],opt_csv_read){1,1}) - opt.baseline_delay;
data.covariates_intrarun_values(3,2) = opt.baseline_duration;
data.covariates_intrarun_values(4,1) = str2num(niak_read_csv_cell([path_folder 'lh.txt'],opt_csv_read){2,1}) - opt.baseline_delay;
