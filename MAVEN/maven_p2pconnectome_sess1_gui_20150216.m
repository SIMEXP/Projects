...
files_in.fmri = niak_grab_fmri_preprocess('/home/porban/database/padindi/preprocess_corrected/',opt_g).fmri; % Replace the folder by the path where the results of the fMRI preprocessing pipeline were stored. 
...
%% Options
opt.folder_out = '/home/porban/database/padindi/results/p2pconnectome_session1/'; % Where to store the results
