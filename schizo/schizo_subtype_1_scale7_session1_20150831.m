...
num_var = [3 7 8 9 10 45 46 47 48]; % num variable in model.csv
name_var = {'schizo','pansspos1','panssneg1','panssgen1','pansstot1','glucose1','cortisol1','insulin1','prolactin1'}; % name variable in model.csv
type_plot = [1 2 2 2 2 2 2 2 2 2 2 2 2]; % 1=boxplot, 2=regression line
...
path_results = '/Users/pyeror/Work/transfert/Schizo/results/subtype/scores_s7/session1_BH05_20150831/';
