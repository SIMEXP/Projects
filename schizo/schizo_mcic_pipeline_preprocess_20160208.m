...
path_raw       = '/gs/project/gsf-624-aa/database2/schizo/raw_data_all/mcic/mnc_data/';
path_preprocess     = '/gs/project/gsf-624-aa/database2/fmri_preproc_all/mcic_preproc_20160208/';
...
groups_list = {'HC','SZ'};
    ...
    for group_n = 1:size(groups_list,2)
        ...
        for num_s = 1:size(subjects_list,1)
            ...
            %func
            fmrirun = dir([path_group filesep subject filesep 'run1' filesep '*.mnc.gz']);
            fmri.session1.run1=[path_group filesep subject filesep 'run1' filesep fmrirun.name];
            
             %func
            fmrirun = dir([path_group filesep subject filesep 'run2' filesep '*.mnc.gz']);
            fmri.session1.run2=[path_group filesep subject filesep 'run2' filesep fmrirun.name];
