...
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'reg_prior_noise_signal.png'], '-dpng');
...
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'shift_prior_noise_signal.png'], '-dpng');
...
axes(legend)
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'reg_prior_noisy_signal_ROC.png'], '-dpng');
...
axes(legend)
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'shift_prior_noisy_signal_ROC.png'], '-dpng');
...
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'reg_prior_clean_signal.png'], '-dpng');
...
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'shift_prior_clean_signal.png'], '-dpng');

%% Plot the ROC analysis for clean signal and regular prior
fig = figure('position',[0 0 1000 650]);
opt.limits = [-1 1];
opt.color_map = 'hot_cold';
...
axes(legend)
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'reg_prior_clean_signal_ROC.png'], '-dpng');

%% Plot the ROC analysis for clean signal and shifted prior
fig = figure('position',[0 0 1000 650]);
opt.limits = [-1 1];
opt.color_map = 'hot_cold';
...
axes(legend)
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'shift_prior_clean_signal_ROC.png'], '-dpng');
...
[X_seed_c_shift, roc_seed_c_shift, ~, AUC_seed_c_shift] = perfcurve(corner_regular_labels, seed_shift_corner(:), true);
[X_dureg_c_shift, roc_dureg_c_shift, ~, AUC_dureg_c_shift] = perfcurve(corner_regular_labels, dureg_shift_corner(:), true);
%% Visualize these things for the smooth signal
%%matlab
fig = figure('position',[0 0 1000 650]);
opt.limits = [-1 1];
opt.color_map = 'hot_cold';

subaxis(2,4,1, 'Spacing', 0.03, 'Padding', 0, 'Margin', 0);
niak_visu_matrix(scores_reg_corner, opt);
title('corner scores');
axis tight
axis off

subaxis(2,4,2, 'Spacing', 0.03, 'Padding', 0, 'Margin', 0);
niak_visu_matrix(seed_reg_corner, opt);
title('corner seed');
axis tight
axis off

subaxis(2,4,3, 'Spacing', 0.03, 'Padding', 0, 'Margin', 0);
niak_visu_matrix(dureg_reg_corner, opt);
title('corner dual regression');
axis tight
axis off

subaxis(2,4,5, 'Spacing', 0.03, 'Padding', 0, 'Margin', 0);
niak_visu_matrix(scores_reg_border, opt);
title('border scores');
axis tight
axis off

subaxis(2,4,6, 'Spacing', 0.03, 'Padding', 0, 'Margin', 0);
niak_visu_matrix(seed_reg_border, opt);
title('border seed');
axis tight
axis off

subaxis(2,4,7, 'Spacing', 0.03, 'Padding', 0, 'Margin', 0);
niak_visu_matrix(dureg_reg_border, opt);
title('border dual regression');
axis tight
axis off
...
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'reg_prior_smooth_signal.png'], '-dpng');
...
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'shift_prior_smooth_signal.png'], '-dpng');
...
suptitle('Regular prior, smooth signal');
axes(legend)
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'reg_prior_smooth_signal_ROC.png'], '-dpng');
...
suptitle('Shifted prior, smooth signal');
axes(legend)
set(fig,'PaperPositionMode','auto');
print(fig, [fig_path filesep 'shift_prior_smooth_signal_ROC.png'], '-dpng');