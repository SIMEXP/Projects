...
%         dureg_reg_border = reshape(beta_reg(border_net, :), [edge, edge]);
        ...
        y_seed = interp1(X_scores_b_shift, roc_scores_b_shift, ref_x);
        y_dureg = interp1(X_scores_b_shift, roc_scores_b_shift, ref_x);
        
        
        tpr_cell(p_id, :, 1) = roc_scores_b_shift;
        tpr_cell(p_id, :, 2) = roc_seed_b_shift;
        tpr_cell(p_id, :, 3) = roc_dureg_b_shift;
