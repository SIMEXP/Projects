...
path_data = '/data/cisl/cdansereau/multisite/simulations_corr/prediction_sim/'
    ...
    for i_balancing=1:size(balancing,2)
        ...
        for num_p = 1:length(list_p)
            for num_e = 1:length(list_effect_size)
                clear job
                job.in = [path_data filesep 'n_subject_estimation_bis_prediction.mat'];
        ...
        pipeline.summary_simu_power.command = ...
         ...
         'end;' ...
         'sens_monosite_h0(num_p,num_e,:) = mean(data.sens_monosite_h0);' ...
         'sens_monosite_h0_std(num_p,num_e,:) = std(data.sens_monosite_h0);' ...
         'sens_multisite_h0(num_p,num_e,:) = mean(data.sens_multisite_h0);' ...
         'sens_multisite_h0_std(num_p,num_e,:) = std(data.sens_multisite_h0);' ...
         'sens_multisite_h0_dummy(num_p,num_e,:) = mean(data.sens_multisite_h0_dummy);' ...
         'sens_multisite_h0_dummy_std(num_p,num_e,:) = std(data.sens_multisite_h0_dummy);' ...
         'sens_monosite(num_p,num_e,:) = mean(data.sens_monosite);' ...
         'sens_monosite_std(num_p,num_e,:) = std(data.sens_monosite);' ...
         'sens_multisite_nocorr(num_p,num_e,:) = mean(data.sens_multisite_nocorr);' ...
         'sens_multisite_nocorr_std(num_p,num_e,:) = std(data.sens_multisite_nocorr);' ...
         'sens_multisite_dummyvar(num_p,num_e,:) = mean(data.sens_multisite_dummyvar);' ...
         'sens_multisite_dummyvar_std(num_p,num_e,:) = std(data.sens_multisite_dummyvar);' ...
         'end;' ...
         'end;' ...
