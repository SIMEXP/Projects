...
num_var = [69 70 71 72 73]; % num variable in model.csv
name_var = {'subt1_tot','subt2_tot','subt3_tot','subt4_tot','subt5_tot'}; % name variable in model.csv
type_plot = [2 2 2 2 2]; % 1=boxplot, 2=regression line
...
model = '/Users/pyeror/Work/transfert/PreventAD/models/adsf_model_preventad_bl_dr2_subt_20160125.csv';
template_file = 'rest1_rmap_part.nii.gz';
path_data_1 = '/Users/pyeror/Work/transfert/PreventAD/results/scores/preventad/rmap_part_run1/';
path_results = '/Users/pyeror/Work/transfert/PreventAD/results/subtype/preventad_232_s7_5subtypes_rmaps_structural_BH05_confounds_run1/';
