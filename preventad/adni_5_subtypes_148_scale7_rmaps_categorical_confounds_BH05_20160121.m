...
path_results = '/Users/pyeror/Work/transfert/PreventAD/results/subtype/adni_148_s7_5subtypes_rmaps_BH05_categorical_confounds/';
...
for n_net = 1:length(num_net)
    ...
    opt.labels_y = {'subt1','subt2','subt3','subt4','subt5','subt6','subt7'};
    opt.labels_x = sub_id;
