%% regress sex age fd sites before subtypes
...
path_results = '/Users/pyeror/Work/transfert/PreventAD/results/subtype/admci_20160221_subtype12/';
...
for n_net = 1:length(num_net)
    ...
    for n_var = 1:length(num_var)
        ...
        opt_glm.multisite = tab2(:,num_multisite);
