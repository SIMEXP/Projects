...
% The number of admci subjects (pooled ad & mci) is balanced across the 9 sites.
% Here we only run the pipeline on the first run available.

clear all
addpath(genpath('/gs/project/gsf-624-aa/quarantaine/niak-boss-0.13.4/'))

path_data = '/gs/project/gsf-624-aa/data/';
path_folder_out = '/gs/project/gsf-624-aa/database2/preventad/results/admci_balanced2_scores_s007_20160222/';
...
%% model
model = '/gs/project/gsf-624-aa/database2/preventad/models/admci_model_balanced2_20160222.csv';
