clear;
addpath(genpath('/home/porban/niak/')); % git clone 20160704 2.56pm
...
mask_path = '/home/porban/gsf-624-aa/database2/preventad/mask_mnc/mask.mnc';
out_path = '/gs/project/gsf-624-aa/database2/preventad/results/subtype_admci_s07_gui_20160704/';
...
opt.subtype.group_col_id = 'admci';
