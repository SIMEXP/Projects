%% script to subtype on adni dartel: whole brain and glm for diagnosis (regress out age, sex, tiv, mean whole brain gm)

clear all

%% set up paths
path_data = '/home/atam/scratch/dartel_subtypes/adni_dartel/raw_mnc';
path_out = '/home/atam/scratch/dartel_subtypes/adni_dartel/dartel_wb_subtypes_20160926/';

%% set up files_in structure

files_in.model = '/home/atam/scratch/dartel_subtypes/adni_dartel/model/adni_dartel_model_20160913.csv';
...
opt.scale = 1;
opt.stack.regress_conf = {'age','sex','tiv','mean_gm'};
