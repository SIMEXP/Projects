...
in.data = [path 'preventad_civet_vertex_bl_20160316.mat']; % .mat file containing vertex-based cortical thickness measures for each subject
opt.name_data = 'ct'; % select the correct variable from .mat
opt.folder_out = '/home/atam/scratch/adsf/adsf_basc_ct_20160316/';
