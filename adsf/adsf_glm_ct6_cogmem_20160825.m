...
path_out = '/Users/AngelaTam/Desktop/adsf/glm_ct6_mem_20180825/';
psom_mkdir(path_out);

nb_net = 6; % number of the desired networks
...
file_res = [path_out 'adsf_glm_ct6_mem_20160819.mat'];
list_contrast = {'ct6_1','ct6_2','ct6_3','ct6_4'};
