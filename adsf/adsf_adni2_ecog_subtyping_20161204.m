...
files_in.data = [path_data 'cognitive_subtypes/adni2_ecog_stack.mat'];
files_in.model = [path_data 'rsfmri_subtypes/adni/adni2_model_20161202.csv'];
files_out = [path_data 'cognitive_subtypes/adni2_ecog_stack_r_20161204.mat'];
...
path_data = '/Users/AngelaTam/Desktop/adsf/';
files_in.data = [path_data 'cognitive_subtypes/adni2_ecog_stack_r_20161204.mat'];
files_out = struct;
opt.folder_out = 'adni_cog/ecog_20161204';
...
path_data = '/Users/AngelaTam/Desktop/adsf/';
files_in.data.network1 = [path_data 'cognitive_subtypes/adni2_ecog_stack_r_20161204.mat'];
files_in.subtype.network1 = '/Users/AngelaTam/Desktop/adsf/cognitive_subtypes/adni_cog/ecog_20161204/subtype.mat';
files_out = struct;
opt.folder_out = 'adni_cog/ecog_20161204';
opt.scales = 1;
