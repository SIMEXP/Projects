%% glm on whole brain dartel adni subtypes on moca
...
files_out = struct;
opt.folder_out = [a_path 'glm_moca_codxedu_20161004'];
opt.scale = 1;
opt.contrast.MOCA = 1;
opt.contrast.age = 0;
opt.contrast.sex = 0;
...
files_in.association = [a_path 'glm_moca_codxedu_20161004/association_stats.mat'];
files_out = struct;
