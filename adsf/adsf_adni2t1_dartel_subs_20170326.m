...
path_results = '/home/atam/scratch/dartel_subtypes/adnit1_dartel_20170327/7clus';  
...
opt.scale = 1;
opt.stack.regress_conf = {'sex','age_bl','mean_gmd_wb','manufacturer','TIV'};

opt.subtype.nb_subtype = 7;
