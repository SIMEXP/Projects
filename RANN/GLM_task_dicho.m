...
%% Options 
%%%%%%%%%%%%
opt.folder_out = [path_data 'RANN_GLMconnectome/GLM_syn_all_160625']; % Where to store the resultsb
...
opt.test.ageYvsO.group.contrast.FD_syn = 0; % regress out confounding variable
opt.test.ageYvsO.group.select(1).label = 'filter_in_syn'; % select only antonym tasks (filtered on FD and perf criteria)
...
opt.test.eduHvsL.group.contrast.FD_syn = 0; % regress out confounding variable
opt.test.eduHvsL.group.select(1).label = 'filter_in_syn'; % select only antonym tasks (filtered on FD and perf criteria)
opt.test.eduHvsL.group.select(1).values = 1;

%%% PERFORMANCE
opt.test.perfHvsL.group.contrast.Syn_Perf = 1; % define contrast of interest
...
opt.test.perfHvsL.group.contrast.FD_syn = 0; % regress out confounding variable
opt.test.perfHvsL.group.select(1).label = 'filter_in_syn'; % select only antonym tasks (filtered on FD and perf criteria)
...
opt.test.avg_one.group.contrast.FD_syn = 0; % regress out confounding variable
opt.test.avg_one.group.select(1).label = 'filter_in_syn'; % select only antonyms
...
opt.test.avg_two.group.contrast.FD_syn = 0; % regress out confounding variable
opt.test.avg_two.group.select(1).label = 'filter_in_syn'; % select only synonyms
