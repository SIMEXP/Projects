...
%% Options 
%%%%%%%%%%%%
opt.folder_out = [path_data 'RANN_GLMconnectome/GLM__ant_test_sexe_160715']; % Where to store the resultsb
...
%%% SEXE (0=F, 1=M)
opt.test.sexe.group.contrast.genderFM = 1; % define contrast of interest (FD continuous only)
