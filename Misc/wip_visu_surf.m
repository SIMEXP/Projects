...
%      Supports 'hot_cold' in addition to standard matlab maps. 
%
% _________________________________________________________________________
% OUTPUTS :
%
...
list_fields   = { 'style' , 'limits' , 'title'      , 'background' , 'lighting' , 'material' , 'shading' , 'color_map' };
