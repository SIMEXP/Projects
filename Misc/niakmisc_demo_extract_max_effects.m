...
path_net  = [path_ref 'cobre_glm_connectome_nii' filesep 'sci10_scg10_scf10' filesep];
path_maps = [path_net 'szVScont_age_sex_FD' filesep];
file_eff  = [path_maps 'effect_szVScont_age_sex_FD_sci10_scg10_scf10.nii.gz'];
[hdr,eff] = niak_read_vol(file_eff);
file_net  = [path_net 'networks_sci10_scg10_scf10.nii.gz'];
...
niak_write_csv([path_ref 'summary_max_eff.csv'],tab,opt_csv);
