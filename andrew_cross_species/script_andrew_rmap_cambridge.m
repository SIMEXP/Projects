...
path_write = '/media/database8/nki_enhanced/rmap_cambridge/';
...
files_in.network = [gb_niak_path_niak filesep 'template' filesep 'basc_cambridge_sc100.mnc.gz'];
files_in.seeds = [gb_niak_path_niak filesep 'template' filesep 'list_seeds_cambridge_100.csv'];
