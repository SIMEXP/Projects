...
%% Pipeline manager 
opt.psom.qsub_options = '-q qwork@ms -l nodes=1:m32G,walltime=20:00:00';
...
opt.smooth_vol.fwhm      = 0;  % Full-width at maximum (FWHM) of the Gaussian blurring kernel, in mm.
