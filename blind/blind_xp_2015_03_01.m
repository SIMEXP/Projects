...
[hdr,sc8] = niak_read_vol([path_data 'networks_sci13_scg13_scf13.nii.gz']);
mask = sc159>0;
part159 = sc159(mask);
part8 = sc8(mask);
...
%% Load GLM
glm = load([path_data 'tvr_CBvsSC/glm_tvr_CBvsSC_sci180_scg162_scf159.mat']);
model = glm.model_group;
opt_test.q = 0.1;
opt_test.q_omni = 0.05;
opt_test.method = 'TST';
opt_test.nb_samps = 1000;
res = niak_network_fdr(model,part,opt_test);
hdr.file_name = [path_data 'tvr_CBvsSC/perc_disc_network_fdr.nii.gz'];
