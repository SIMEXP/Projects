...
path_fmri = '/gs/project/gsf-624-aa/database2/data/hnu1/preproc_20160215/fmri/';
...
%% model
model = '/gs/project/gsf-624-aa/database2/data/hnu1/model/hnu1_model_20160215.csv';
